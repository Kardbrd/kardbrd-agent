...
WIZARD_CARD_DESCRIPTION = (  # noqa: E501 — long markdown template
    ...
    "\n"
    "#### Skill Discovery\n"
    "- **Read `.claude/skills/*/SKILL.md`** files from the repository "
    "to find available skills\n"
    "- Each subdirectory is a skill — the directory name "
    "prefixed with `/` is the command "
    "(e.g., `skills/explore/SKILL.md` → `/explore`)\n"
    ...
    "- If no `.claude/skills/` directory exists, "
    ...
    "`.claude/skills/*/SKILL.md` in the git repository. "
    ...
    "```\n"
    ".claude/skills/explore/SKILL.md    → /explore\n"
    ...
    ".claude/skills/docs/SKILL.md       → /docs\n"
    "```\n"
    "\n"
